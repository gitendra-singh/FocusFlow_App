...
import com.example.focusflow.presentation.components.TaskCheckBox
import com.example.focusflow.presentation.components.TaskDatePicker
import com.example.focusflow.util.Priority
import com.example.focusflow.util.SnackBarEvent
import com.example.focusflow.util.changeMillisToDateString
...
private fun TaskScreen(
    ...
    taskTitleError = when {
        state.title.isEmpty() -> "Please enter task title."
